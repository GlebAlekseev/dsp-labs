...
fun PhaseSpectrumPlot(data: LineChartData, title: String = "Фазовый спектр", modifier: Modifier = Modifier) {
    ChartLayout(
        modifier = modifier,
