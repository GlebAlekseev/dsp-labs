...
fun AnalogSignalPlot(data: LineChartData, title: String = "Аналоговый сигнал", modifier: Modifier = Modifier) {
    ChartLayout(
        modifier = modifier,
        ...
        XYChart(
            ...
            yAxisLabels = {
                AxisLabel(String.format("%.9f", it), Modifier.absolutePadding(right = 2.dp))
            },
            yAxisTitle = {
                AxisTitle(
                    "S(t), В",
